...
import 'package:chain_wallet_mobile/presentation/shared/extensions/i18n_extensions.dart';
import 'package:chain_wallet_mobile/presentation/shared/transparent_image.dart';
import 'package:chain_wallet_mobile/presentation/shared/utils/modal_bottom_sheet_utils.dart';
...
class AccountBarTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      onTap: () => ModalBottomSheetUtils.showAppModalBottomSheet(context, EndDrawerItemType.wallets),
